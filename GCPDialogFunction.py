def  quickstart_add_data_two(multiplier,multiplicand,answer,responsetext,headers):
    ...
    doc_ref.set({
        ...
        u'result': responsetext,
        u'datestring': headers['datestring'],
        u'timestring': headers['timestring'],
    })
...
def hello_world(request):
    ...
    if(queryResult['action'] == 'genMultiplicationDummyAction'):
      ...
      quickstart_add_data_two(multiplier,multiplicand,answer,responsetext,request.headers)
